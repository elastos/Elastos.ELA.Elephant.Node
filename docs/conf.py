...
htmlhelp_basename = 'Elephant Node doc'
...
man_pages = [
    (master_doc, 'Elephant Node', 'Elephant Node Documentation', [author], 1),
]
...
texinfo_documents = [
    (
        master_doc,
        'Elephant Node',
        'Elephant Node Documentation',
        author,
        'Elephant Node',
        'One line description of project.',
        'Elephant Node ellaneous',
    ),
]
